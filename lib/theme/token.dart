...
class AntdMapToken {
  ...
  AntdMapToken copyWith({
    AntdSizeDefine? size,
    AntdRadiusDefine? radius,
    AntdColorDefine? colorInfo,
    AntdColorDefine? colorLink,
    AntdColorDefine? colorPrimary,
    AntdColorDefine? colorSuccess,
    AntdColorDefine? colorWarning,
    AntdColorDefine? colorError,
    AntdTextColorDefine? colorText,
    AntdFontDefine? font,
    AntdFillColorDefine? colorFill,
    Color? colorBgBlur,
    ...
    BorderSide? border,
    BorderSide? borderSecondary,
    double? lineWidth,
    Color? colorWhite,
    Color? colorTransparent,
    Color? colorBlack,
    FontWeight? fontWeightStrong,
    AntdShadowDefine? shadow,
  }) {
    return AntdMapToken(
      size: size ?? this.size,
      ...
      colorTransparent: colorTransparent ?? this.colorTransparent,
