"use strict";(self.webpackChunkantd_flutter_mobile=self.webpackChunkantd_flutter_mobile||[]).push([[4723],{74723:function(a,e,n){n.r(e),n.d(e,{texts:function(){return t}});const t=[{value:"\u9AD8\u6027\u80FD\u8868\u5355\u63A7\u4EF6\uFF0C\u81EA\u5E26\u6570\u636E\u57DF\u7BA1\u7406\u3002\u5305\u542B\u6570\u636E\u5F55\u5165\u3001\u6821\u9A8C\u4EE5\u53CA\u5BF9\u5E94\u6837\u5F0F\u3002",paraId:0},{value:"\u9002\u7528\u4E8E\u521B\u5EFA\u4E00\u4E2A\u5B9E\u4F53\u6216\u6536\u96C6\u4FE1\u606F\u3002\u9700\u8981\u5BF9\u8F93\u5165\u7684\u6570\u636E\u7C7B\u578B\u8FDB\u884C\u6821\u9A8C\u65F6\u3002",paraId:1,tocIndex:0},{value:`class AntdFormDemo extends StatelessWidget {
            ...
            return Column(children: [
              ...
              AntdList(shrinkWrap: true, items: [
                AntdFormItem(
                    ...
                    label: const Text("\u5F00\u5173"),
                    builder: (ctx) {
                      return const AntdSwitch(defaultValue: "any");
                    }),
                AntdFormItem(
                    name: "selector",
                ...
                AntdFormItem(
                    ...
                    label: const Text("\u5355\u9009"),
                    builder: (ctx) {
                      return const AntdRadio(defaultValue: 1, extra: Text("1"));
                    }),
                AntdFormItem(
                    name: "radioGroup",
                    ...
                    builder: (ctx) {
                      return const AntdRadioGroup(items: [
                        AntdRadio(defaultValue: 1, extra: Text("1")),
                        AntdRadio(defaultValue: 2, extra: Text("2"))
                      ]);
                    }),
                AntdFormItem(
                    name: "checkbox",
                    ...
                    builder: (ctx) {
                      return const AntdCheckbox(
                          defaultValue: 1, extra: Text("1"));
                    }),
                AntdFormItem(
                    name: "checkboxGroup",
                    label: const Text("\u591A\u9009\u9009\u62E9\u7EC4"),
                    builder: (ctx) {
                      return const AntdCheckboxGroup(defaultValue: [
                        '1'
                      ], items: [
                        AntdCheckbox(defaultValue: "1", extra: Text("1")),
                        AntdCheckbox(defaultValue: "2", extra: Text("2"))
                      ]);
                    }),
                AntdFormItem(
                    name: "input",
